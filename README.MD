...
<img size='100%' src=".github/img.png" alt="screen" border="0">

## 💻 Projeto
O projeto busca utiliza a api do [GitHub](https://docs.github.com/rest) e traz informações de um usuário  
